...
public class BoardController {
	...
	/*
	 * 게시글 건수 확인 메서드 count() 생성으로 인한 삭제 // 게시글 목록 페이지
	 * 
	 * @RequestMapping(value = "/list", method = RequestMethod.GET) public void
	 * list(Model model) throws Exception { // 로그인한 사용자 정보 획득
	 * 
	...
	public void list(@ModelAttribute("pgrq") PageRequest pageRequest, Model model) throws Exception {
		...
		Pagination pagination = new Pagination(); // pagination 인스턴스 생성
		pagination.setPageRequest(pageRequest); // PageRequest 객체 설정
	...
	// 게시글 삭제 페이지, 페이징 요청 정보를 매개변수로 받고 다시 뷰에 전달한다.
	@RequestMapping(value = "/remove", method = RequestMethod.POST)
	@PreAuthorize("hasAnyRole('ROLE_ADMIN', 'ROLE_MEMBER')")
	public String remove(Integer boardNo, PageRequest pageRequest, RedirectAttributes rttr) throws Exception {
